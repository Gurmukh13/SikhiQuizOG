...
public class MainActivity extends Activity {
		...
		timer = new TimerTask() {
			...
			public void run() {
				runOnUiThread(new Runnable() {
					@Override
					public void run() {
						splash.setClass(getApplicationContext(), LoadingActivity.class);
	...
	public void _AVLd(final String _key) {
		...
		v.setIndicatorColor(Color.WHITE);
	...
	public void _Music() {
		mp = MediaPlayer.create(getApplicationContext(), R.raw.nagara_sound);
		mp.setLooping(true);
		timer = new TimerTask() {
			@Override
			public void run() {
